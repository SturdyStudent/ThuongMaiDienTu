...
function PaymentSection() {
  return (
    <div>
      ...
      <label className='fontweight'>PHƯƠNG THỨC THANH TOÁN</label><br />
      ...
      <div className='display-flex'>
        <div className='margin-right' >
          <div className='fontweight'>Loại Card</div>
        ...
        <div>
          <div className='fontweight'>Số tài khoản</div>
          <input type={"text"} className='checkout-login-input padding-select' style={{ "width": "20vw" }}></input>
        </div>
      </div>
      <br />
      <label className='fontweight'><span style={{ "color": "red" }}>*</span > Ngày hết hạn </label><br />
